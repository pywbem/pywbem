...
TESTCASES_SUBMGR = [
    ...
    (
        "Valid submgr id and server id",
        {
            ...
            'subscription_attrs': None,
            'remove_server_attrs': None,
            'exp_result': {'server_id': "http://FakedUrl:5988"}
        },
        None, None, RUN
    ),
    (
        "Valid submgr id and multiple server ids",
        {
            ...
            'remove_server_attrs': None,
            'exp_result': {
                'server_id': ["http://FakedUrl:5988", "http://fake2:5988"]}
        },
        None, None, OK
    ),
    (
    ...
    (
        ...
        {
            'submgr_id': "ValidID",
            'connection_attrs': [{'url': None}, {'url': None}],
            'filter_attrs': {
                'server_id': "http://FakedUrl:5988",
                'source_namespaces': 'root/interop',
                'query': "SELECT * from blah",
