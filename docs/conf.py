...
if "dev" in release:
    print(f"conf.py: Building development version {version}", flush=True)
    print("conf.py: Generating change log entries using towncrier", flush=True)
    cmd = f'towncrier build --draft --version {version} >tmp_changes.rst'
    print(f"conf.py: {cmd}", flush=True)
    os.system(cmd)
    # The following "tags" object is injected by Sphinx at runtime.
    tags.add("dev")  # noqa: F821 pylint: disable=undefined-variable
else:
    print(f"conf.py: Building release version {version}", flush=True)
...
exclude_patterns = ["listener_design.rst", "changes",
...
nitpick_ignore = [
    ...
    ("py:obj", r'pywbem.VersionError.add_note'),
    ("py:obj", r'pywbem.VersionError.with_traceback'),
    ("py:obj", r'pywbem.VersionError.conn_id'),
    ("py:obj", r'pywbem.VersionError.conn_str'),
    ("py:obj", r'pywbem.CIMVersionError.add_note'),
    ("py:obj", r'pywbem.CIMVersionError.with_traceback'),
    ("py:obj", r'pywbem.CIMVersionError.conn_id'),
    ("py:obj", r'pywbem.CIMVersionError.conn_str'),
    ("py:obj", r'pywbem.DTDVersionError.add_note'),
    ("py:obj", r'pywbem.DTDVersionError.with_traceback'),
    ("py:obj", r'pywbem.DTDVersionError.conn_id'),
    ("py:obj", r'pywbem.DTDVersionError.conn_str'),
    ("py:obj", r'pywbem.ProtocolVersionError.add_note'),
    ("py:obj", r'pywbem.ProtocolVersionError.with_traceback'),
    ("py:obj", r'pywbem.ProtocolVersionError.conn_id'),
    ("py:obj", r'pywbem.ProtocolVersionError.conn_str'),
    ...
    ("py:obj", r'pywbem.ListenerStartError.add_note'),
    ("py:obj", r'pywbem.ListenerStartError.with_traceback'),
