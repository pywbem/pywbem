...
class WBEMConnection:
    ...
    def methodcall(self, methodname, localobject, **params):
        ...
        def paramvalue(obj):
            ...
            parameter."""
            if (isinstance(obj, (cim_types.CIMType, bool, StringTypes)) or
        ...
        plist = [cim_xml.PARAMVALUE(x[0], paramvalue(x[1]), paramtype(x[1]))
