...
def csv_list(string):
    """
    Return a a list of the strings from the comma-separated string input.

    This is a support function for argparse.
    """
    return string.split(',')
...
""" % (prog, prog)
    ...
    pos_arggroup.add_argument(
        ...
        help='R|Host name or url of the WBEM server in this format:\n'
             ...
             '     - HTTPS - 5989\n')
    pos_arggroup.add_argument(
        'object', metavar='object', nargs='?',
        help='R|Object of the command.  May be class, instance, or Null\n'
    ...
    # '-o', '--object', dest='object', metavar='object',
    # default='',
    # help='R|Object that is the subject of the request. May be either\n'
    # 'Class or instance depending on the command')
    server_arggroup.add_argument(
    ...
    requestoption_arggroup = argparser.add_argument_group(
        'Request options group')
    # role, resultrole, etc.
    requestoption_arggroup.add_argument(
        '-di', '--deepinheritance', dest='deep_inheritance',
        action='store_true', default=None,
        help='Add deepinheritance option to the request')
    requestoption_arggroup.add_argument(
        '-iq', '--includequalifiers', dest='include_qualifiers',
        action='store_true', default=None,
        help='Include qualifiers in response')
    requestoption_arggroup.add_argument(
        '-nlo', '--not-localonly', dest='not_local_only',
        action='store_false', default=None,
        help='R|Add local-only == False option to the request. LocalOnly ==\n'
             'True is the default action')
    requestoption_arggroup.add_argument(
        '-ico', '--includeclassorigin', dest='include_classorigin',
        action='store_true', default=None,
        help='Add includeclassorigin option to the request')
    requestoption_arggroup.add_argument(
        '-pl', '--propertylist', dest='property_list',
        type=csv_list,
        help='R|Return only the properties in the list. The list is a\n'
             'comma-separated list of property names.')

    # output_arggroup = argparser.add_argument_group(
    # 'Output options group')
    # -s summary, mof, xml, txt, etc.
